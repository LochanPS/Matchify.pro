...
export default function TournamentCategoryDetails() {
  ...
  const stats = [
    { label: 'Participants', value: category.stats.totalParticipants, icon: Users, color: '#F59E0B', glow: 'rgba(245,158,11,0.2)' },
    { label: 'Total Matches', value: category.stats.totalMatches, icon: Swords, color: '#FCD34D', glow: 'rgba(245,158,11,0.2)' },
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden" style={{ background: 'linear-gradient(180deg, #0a0a1f 0%, #050810 40%, #0d1a2a 70%, #050810 100%)' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, rgba(245,158,11,0.2), rgba(245,158,11,0.15))', border: '1px solid rgba(245,158,11,0.4)', color: '#F59E0B' }}
            >
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-5 space-y-5">
        ...
        {/* Participants */}
        <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid rgba(245,158,11,0.15)', background: 'rgba(7,7,26,0.6)', backdropFilter: 'blur(20px)' }}>
          {/* Header */}
              ...
              category.participants.map((participant, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {participant.partner && (
                      <p className="text-xs font-medium mt-0.5 truncate" style={{ color: '#F59E0B' }}>
