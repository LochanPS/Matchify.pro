...
const QRSettingsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Admin Payment QR Code Settings</h1>
        <p className="text-gray-400">
          This QR code is used for ALL tournament payments. Players pay to admin (P S Lochan - 9742628582@sbi), 
          then admin pays organizers their 45% share (50% before + 50% after tournament). Admin keeps 5% platform fee.
        </p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <ul className="text-gray-300 space-y-2 text-sm">
              ...
              <li>• <strong className="text-teal-400">Upload your QR code here</strong> so Matchify.pro can pay you your 95% share</li>
              <li>• You'll receive <strong className="text-yellow-400">50% before the tournament</strong> and <strong className="text-yellow-400">50% after completion</strong></li>
